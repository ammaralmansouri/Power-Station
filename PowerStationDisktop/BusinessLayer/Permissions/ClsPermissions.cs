...
namespace PowerStationDisktop.BusinessLayer.Permissions
{
    class ClsPermissions
    {
        ...
        public void UpdateStartAndEndDateOfCollection(DateTime StartOfCollectionDate, DateTime EndOfCollectionDate)
        {
            DataAccessLayer.ClsConnection con = new DataAccessLayer.ClsConnection();
            con.OpenConnection();
            ...
            con.ExecuteCommands("Update_Start_And_End_Date_Of_Collection", para);
            con.CloseConnection();
        }

        public void SetExpiredDateLikeEndOfCollectionDate(DateTime EndOfCollectionDate)
        { 
            ...
            con.ExecuteCommands("Set_ExpiredDate_Like_EndOfCollectionDate", para);
            con.CloseConnection();
        }
